      ...
      <div class="row no-gutters">
        ...
        <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch" data-aos="fade-up" data-aos-delay="100">
          <div class="count-box">
            ...
            <p><strong>Total</strong> Commandes</p>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch" data-aos="fade-up" data-aos-delay="200">
          <div class="count-box">
            ...
            <p><strong>Total</strong>Revenus</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch" data-aos="fade-up">
          <div class="count-box">
            ...
            <p><strong>Total</strong> Clients</p>
          </div>
        </div>
...
<section id="about" class="about">
    ...
    <div class="container">
      ...
      <a href="{{route('categorie.nouveau')}}">Ajouter une catégorie</a>
       <div class="row">
       <!-- <div class="col-4"> -->
<!--
      ...
      <a href="{{route('categorie.details',['categorie'=>$categorie->nom,'id'=>$categorie->id])}}">{{$categorie->nom}}</a>
                          ...
                          <img src="{{asset('storage').'/'.$categorie->photo}}" class="img-fluid" alt="" style="width:100px;height:100px;" class="bf5 border rounded-circle">
